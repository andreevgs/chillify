...
export class AllEntitiesWithBasicFields1643032270949 implements MigrationInterface {
    name = 'AllEntitiesWithBasicFields1643032270949'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`INSERT INTO statuses ("nameRu") VALUES ('нет ответа'), ('не смогу'), ('скорее всего'), ('точно буду')`);
    }
